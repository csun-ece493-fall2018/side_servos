...
HD_PWD='C:/Users/hs696802/Desktop/servos_new/servos_new.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log servos.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source servos.tcl -notrace
