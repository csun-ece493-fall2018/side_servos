...
# JA Pmod - Bank 13
# ---------------------------------------------------------------------------- 
#set_property PACKAGE_PIN Y11  [get_ports {ack_left}];  # "JA1"
#set_property PACKAGE_PIN AA8  [get_ports {ack_right}];  # "JA10"
#set_property PACKAGE_PIN AA11 [get_ports {ack_right}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {pwm_left}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {pwm_right}];  # "JA4"
